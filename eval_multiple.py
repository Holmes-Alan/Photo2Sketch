...
from network import Vgg19, Encoder, Img_decoder_v3_m, discriminator_v2, Inverse
...
parser.add_argument("--image_dataset", default="/media/server2/HDDShare/NTIRE2021/data/SR/DIV2K/",
                    help='image dataset')
...
def eval():
    ...
    HR_filename = os.path.join(opt.image_dataset, 'multiple')
    # LR_filename = os.path.join(opt.image_dataset, 'hazy')
    SR_filename = os.path.join(opt.image_dataset, 'multiple_our')
